...
Status: prepared handoff. The completed 25-bot imported hour fails behavior acceptance with unresolved Quest progress gaps. Geometry, Refusal stability and the four injured-healer intervals are clear. The collection-search correction passes both focused cases. Both defensive combat checks pass. Moving-target cast preparation and the two-minute Completed Quest wait bound remain under test. Core #516 and #518 are merged. Core #519 holds the combined gameplay callers; final Package composition and CI remain pending. Argus access, deployment approval, the deployed Gateway and human attendance remain pending. No attended client observation or configured Realm operation has occurred.
...
- Core merge `fd2687f3056f2964d75bbd483bde68a463499434`, tree `c780a9bfd53823b6e2d88102cfc6da698657f137`, following PR #518 at reviewed head `d57a9415abc056e3de3378042484abd315a7619b`.
- Package Collection PR #36 head `a88e828a7704a4b78e45511f956855a164a69931`, tree `448bc7f29f0d96b37495ebf7b02a382d8aa497f1`.
...
The recorded build uses Core `24ab2c718f9451be993922ac948ddeff02a29b5e` and Collection `2fdc43d0f85cad25296a877578917af74aeac54e`, tree `34394159414ff5ee1a06bed0fcc06f0e027c73bb`. The current Core adds only recovery test-caller corrections. The current Collection changes only four Core CI references. Its playerbots and dungeons trees match the build exactly. The session template records current source and actual Wasm source separately.
...
The preceding imported hour used Core `607ca975` and Collection `be599eb0`. It completed all 3,600 seconds with 25 bots, clear static geometry and zero Refusal-spam candidates. Imported behavior failed because bots repeatedly chose the same Quest fallback and lost its Loot Tag race. Seven advancement gaps remained open, and one Grind interval lacked target evidence. Independent assessment SHA-256 `47a8a266458a86944ee09c0e1e8e30899d5116e98ba4c4ae064aa40dff8b6107`. Its focused correction passed and received a fresh full hour with the complete eight-entry capture scope.

The preceding driver exited 1 during private-directory cleanup after capture. Its original run and traceback remain preserved. Separate reviewed receipts record the stopped owned process and completed private cleanup. This repair does not change that failed behavior result.

Core #516 merged as `ba6f1ba57b672c7c468a6a9786d02f4fdef84cdb`; Core #518 merged as `fd2687f3056f2964d75bbd483bde68a463499434`. Both passed every required check and preserve the recorded production code. Both Collection `a88e828a` workflows have finished. Durable gameplay failed on five callers that assume a fixed replacement target or inspect a transient Cast row too late. Every other job passed, including all 46 composition cases and all three class jobs. Core #519 contains the reviewed caller corrections. The next full Package durable suite will exercise all five. Earlier productive-target, relocation, recovery and Transfer evidence remains at its actual source identities. Collection delivery remains held for behavior acceptance and the reviewed correction.

The fresh hour completed all 3,600 seconds with 25 bots and closed private cleanup successfully at 18:06:27 UTC on 12 September. All bots reached level 2 or higher, but eight progress intervals remained open. The behavior report flags 558 intervals and zero Refusal-spam candidates. Geometry is clear across 108,175 segments; all four injured-healer intervals contain active work and resolved self-healing. Imported behavior fails acceptance while the remaining gaps are resolved. Behavior report SHA-256 `d77b09a6873fcc4ccf562b4c9b8d27404d1140457dc1a895d0c6f916f92cdf8f`; ownership report `72948545820c69c3bbf4352695074b8b91f0dd4f632e974b5c2574705291fe94`. The isolated collection-search correction passes its real-gameplay regression and the unchanged no-live-target boundary. A separate 231.727452-second Quest 18 gap contains three Mage deaths while generic Defense forces melee attacks and changes targets. Both defensive combat checks pass, including real class casting, retained-target selection and the existing progress and return-home boundary. Moving-target cast preparation and the Completed Quest wait correction remain under test. These isolated corrections are not yet part of the candidate above.
