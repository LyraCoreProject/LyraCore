...
parity_test!(parity_game_account_character_owner, "game_account_character_owner", lyracore_module::AccountCharacterOwner, bindings::account_character_owner_type::AccountCharacterOwner, {
    character_guid, account_id, account_name,
});
...
parity_test!(parity_game_auction_bid_hold, "game_auction_bid_hold", lyracore_module::AuctionBidHold, bindings::auction_bid_hold_type::AuctionBidHold, {
    operation_id, bidder_guid, auction_id, offer, outcome, revision, result_bidder_guid,
    result_bid, minimum_increment, deferred_refund, accepted_price, house, operation,
});
