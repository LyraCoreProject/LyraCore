...
impl __sdk::InModule for RealmMailConfirmDeliveryArgs {
    type Module = super::RemoteModule;
}

#[allow(non_camel_case_types)]
/// Extension trait for access to the reducer `realm_mail_confirm_delivery`.
///
/// Implemented for [`super::RemoteReducers`].
pub trait realm_mail_confirm_delivery {
...
impl realm_mail_confirm_delivery for super::RemoteReducers {
    fn realm_mail_confirm_delivery_then(
        &self,
        escrow_id: u64,
