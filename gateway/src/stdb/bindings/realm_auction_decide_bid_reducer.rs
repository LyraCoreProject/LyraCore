...
impl From<RealmAuctionDecideBidArgs> for super::Reducer {
...
impl __sdk::InModule for RealmAuctionDecideBidArgs {
    type Module = super::RemoteModule;
}

#[allow(non_camel_case_types)]
/// Extension trait for access to the reducer `realm_auction_decide_bid`.
///
/// Implemented for [`super::RemoteReducers`].
pub trait realm_auction_decide_bid {
    ...
    /// /// Use [`realm_auction_decide_bid:realm_auction_decide_bid_then`] to run a callback after the reducer completes.
...
impl realm_auction_decide_bid for super::RemoteReducers {
    fn realm_auction_decide_bid_then(
        &self,
        operation_id: u64,
        bidder_guid: u64,
