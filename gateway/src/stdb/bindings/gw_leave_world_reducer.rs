...
pub trait gw_leave_world {
    ...
    fn gw_leave_world(&self, request_actor: SessionActor) -> __sdk::Result<()> {
        self.gw_leave_world_then(request_actor, |_, _| {})
    }
...
impl gw_leave_world for super::RemoteReducers {
    fn gw_leave_world_then(
        ...
        self.imp
            .invoke_reducer_with_callback(GwLeaveWorldArgs { request_actor }, callback)
    }
}
