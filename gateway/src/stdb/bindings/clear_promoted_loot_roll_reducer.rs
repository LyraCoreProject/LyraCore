...
impl __sdk::InModule for ClearPromotedLootRollArgs {
    type Module = super::RemoteModule;
}

#[allow(non_camel_case_types)]
/// Extension trait for access to the reducer `clear_promoted_loot_roll`.
///
/// Implemented for [`super::RemoteReducers`].
pub trait clear_promoted_loot_roll {
...
impl clear_promoted_loot_roll for super::RemoteReducers {
    fn clear_promoted_loot_roll_then(
        &self,
        roll_id: u64,
